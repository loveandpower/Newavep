...
REM change-me
set pathdir=/d C:\Users\Kinder\Desktop\Serveur-Gta-V-RP-V2.0.4\server
REM change-me
set startpath="Server" C:\Users\Kinder\Desktop\Serveur-Gta-V-RP-V2.0.4\server\run.cmd +exec serveur.cfg

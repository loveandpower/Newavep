...
globalConf = {
	...
	["CLIENT"] = {
		percentage = 90,				-- Percentage chance of finding keys
...
randomMsg =
{
	"Vous avez trouver les clefs dans la boite a gants...",
	"Les clefs sont sur le contacte ... vous les prenez...",
	"Les Clef sont sour le siége...",
}

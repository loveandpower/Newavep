...
Locales['fr'] = {
  ...
  ['open_menu'] = ' ',
  ['have_deposited'] = 'vous avez deposer x',
  ['have_withdrawn'] = 'vous avez retiré x',
  
  -- A modifier selon l'entreprise
  ['tabac_client'] = 'client Pompiste',
  ['transforming_in_progress'] = 'Transformation du petrole en cours',
  ['feuilletab_taken'] = 'Vous être en train de ramasser du petrole',
  ['press_traitement'] = 'appuyez sur ~INPUT_CONTEXT~ pour Transformer votre petrole',
  ['press_collect'] = 'appuyez sur ~INPUT_CONTEXT~ pour Recolter du petrole',
  ['press_sell'] = 'appuyez sur ~INPUT_CONTEXT~ pour vendre vos produits',
  ['no_tabacsec_sale'] = 'Vous n\'avez plus ou pas assez d\'essence',
  ['no_vin_sale'] = 'Vous n\'avez plus ou pas assez d\'or',
  ['not_enough_feuilletab'] = 'Vous n\'avez plus de petrole',
  --['tabacsec'] = '~g~Génial, un grand cru !~w~',
  ['no_product_sale'] = 'Vous n\'avez plus de produits',
  ['press_traitement_jus'] = 'appuyez sur ~INPUT_CONTEXT~ pour transformer votre petrole',

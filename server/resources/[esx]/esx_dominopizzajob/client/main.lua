...
function OpenCloakroomMenu()
  ...
  local elements = {
        ...
        {label = _U('livreur_outfit'), value = 'livreur_outfit'},
        {label = _U('cuisto_outfit'), value = 'cuisto_outfit'},
      }
      ...
      --menu.close()
        ...
        if data.current.value == 'citizen_wear' then
            ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin)
              TriggerServerEvent("player:serviceOn", "pizza")
        ...
        if data.current.value == 'livreur_outfit' then
            ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin)
              TriggerServerEvent("player:serviceOn", "pizza")
              local playerPed = GetPlayerPed(-1)
              if skin.sex == 0 then
                SetPedComponentVariation(playerPed, 8, 15, 0, 0) --T-shirt
                SetPedComponentVariation(playerPed, 11, 9, 14, 0) --Torse
                SetPedComponentVariation(playerPed, 10, 0, 0, 0) --Decals
                SetPedComponentVariation(playerPed, 3, 0, 0, 0) --Bras
                SetPedComponentVariation(playerPed, 4, 3, 11, 0) --Pantalon
                SetPedComponentVariation(playerPed, 6, 8, 7, 0) --Chaussures
                SetPedComponentVariation(playerPed, 7, 0, 0, 0) --Collier
                SetPedPropIndex(playerPed, 0, 96, 14, 0) -- Helmet
                ...
                SetPedComponentVariation(playerPed, 8, 15, 0, 0) --T-shirt
                SetPedComponentVariation(playerPed, 11, 14, 4, 0) --Torse
                SetPedComponentVariation(playerPed, 10, 0, 0, 0) --Decals
                SetPedComponentVariation(playerPed, 3, 0, 0, 0) --Bras
                SetPedComponentVariation(playerPed, 4, 3, 0, 0) --Pantalon
                SetPedComponentVariation(playerPed, 6, 3, 2, 0) --Chaussures
                SetPedComponentVariation(playerPed, 7, 0, 0, 0) --Collier
                SetPedPropIndex(playerPed, 0, 95, 14, 0) -- Helmet
        ...
        if data.current.value == 'cuisto_outfit' then
            ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin)
              TriggerServerEvent("player:serviceOn", "pizza")
              local playerPed = GetPlayerPed(-1)
              if skin.sex == 0 then
                SetPedComponentVariation(playerPed, 8, 15, 0, 0) --T-shirt
                SetPedComponentVariation(playerPed, 11, 107, 1, 0) --Torse
                SetPedComponentVariation(playerPed, 10, 0, 0, 0) --Decals
                SetPedComponentVariation(playerPed, 3, 0, 0, 0) --Bras
                SetPedComponentVariation(playerPed, 4, 3, 2, 0) --Pantalon
                SetPedComponentVariation(playerPed, 6, 12, 6, 0) --Chaussures
                SetPedComponentVariation(playerPed, 7, 0, 0, 0) --Collier
                SetPedPropIndex(playerPed, 0, 14, 1, 0) -- Helmet
                ...
                SetPedComponentVariation(playerPed, 8, 15, 0, 0) --T-shirt
                SetPedComponentVariation(playerPed, 11, 98, 1, 0) --Torse
                SetPedComponentVariation(playerPed, 10, 0, 0, 0) --Decals
                SetPedComponentVariation(playerPed, 3, 0, 0, 0) --Bras
                SetPedComponentVariation(playerPed, 4, 3, 0, 0) --Pantalon
                SetPedComponentVariation(playerPed, 6, 3, 0, 0) --Chaussures
                SetPedComponentVariation(playerPed, 7, 0, 0, 0) --Collier
                SetPedPropIndex(playerPed, 0, 57, 0, 0) -- Helmet
...
function OpenVaultMenu()
  ...
  if Config.EnableVaultManagement then
    ...
    if PlayerData.job.grade_name == 'boss' then
      table.insert(elements, {label = _U('put_object'), value = 'put_stock'})
    end
          ...
          ESX.UI.Menu.Open(
              'default', GetCurrentResourceName(), 'menu_crafting',
              {
                  ...
                  elements = {
                        ...
                        {label = _U('pateapizza'),  value = 'pateapizza'}, -- Pâte à Pizza
                        {label = _U('pizza1'),     value = 'pizza1'}, -- Chorizo
                        {label = _U('pizza2'),     value = 'pizza2'}, -- Canibale
                        {label = _U('pizza3'),     value = 'pizza3'}, -- Barbecue
                        {label = _U('pizza4'),     value = 'pizza4'}, -- Saumon
                        {label = _U('pizza5'),     value = 'pizza5'}, -- Thon
                        {label = _U('pizza6'),     value = 'pizza6'}, -- 4 Fromage
                        {label = _U('pizza7'),     value = 'pizza7'}, -- Hawaienne Jambon
                        {label = _U('salade'),     value = 'salade'}, -- Salade Fraiche
                  }
              },
              function(data2, menu2)
            
                TriggerServerEvent('esx_dominopizzajob:craftingCoktails', data2.current.value)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_dominopizzajob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_dominopizzajob:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_dominopizzajob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_dominopizzajob:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_dominopizzajob:getFridgeStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_dominopizzajob:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_dominopizzajob:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_dominopizzajob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_dominopizzajob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_dominopizzajob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    for i=1, #Config.Zones[zone].Items, 1 do
        ...
        table.insert(elements, {
            label     = item.label .. ' - <span style="color:purple;">$' .. item.price .. ' </span>',
    ...
    ESX.UI.Menu.Open(
        ...
        function(data, menu)
            TriggerServerEvent('esx_dominopizzajob:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('esx_dominopizzajob:hasEnteredMarker', function(zone)
    ...
    if zone == 'Boissons' then
      CurrentAction     = 'menu_shop'
      CurrentActionMsg  = _U('shop_menu2')
      CurrentActionData = {zone = zone}   
    end

    if zone == 'Dessert' then
      CurrentAction     = 'menu_shop'
      CurrentActionMsg  = _U('shop_menu3')
      CurrentActionData = {zone = zone}
    end

    if zone == 'BoissonsChaudes' then
      CurrentAction     = 'menu_shop'
...
AddEventHandler('esx_dominopizzajob:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_dominopizzajob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_dominopizzajob:hasExitedMarker', LastZone)
            end
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'menu_boss_actions' then --and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:BossMenuOpen1', 'pizza', function(data, menu)
...
AddEventHandler('esx_dominopizzajob:teleportMarkers', function(position)
  ...
  while true do
    ...
    if IsJobTrue() then
        ...
        if IsControlJustReleased(0, Keys["E"]) and isInPublicMarker then
          TriggerEvent('esx_dominopizzajob:teleportMarkers', position)
        end

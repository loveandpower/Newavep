...
Config.OnlyPlayerCar = false --Set false if you want to picklock work on npc car (true-false)
...
Config.CallCopsChance       = 50   --How many % of chance for the car alarm start AND call cops. (0-100)

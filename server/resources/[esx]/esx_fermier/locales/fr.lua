...
Locales['fr'] = {
	-- General
	['cloakroom'] = 'Vestiaire',
	['ferme_clothes_civil'] = 'Tenue Civil',
	['ferme_clothes_ferme'] = 'Tenue de travail',
	['veh_menu'] = 'Garage',
	...
	['press_collect'] = 'appuyez sur ~INPUT_CONTEXT~ pour récolter du blé',
	['press_sell'] = 'appuyez sur ~INPUT_CONTEXT~ pour vendre vos produits',
	['no_tabacsec_sale'] = 'Vous n\'avez plus ou pas assez de farine',
	['no_vin_sale'] = 'Vous n\'avez plus ou pas assez de blé',
	['not_enough_feuilletab'] = 'Vous n\'avez plus de blé',
	['tabacsec'] = '',
	['no_product_sale'] = 'Vous n\'avez plus de produits',
	['press_traitement_jus'] = 'appuyez sur ~INPUT_CONTEXT~ pour transformer votre blé',
	['used_jus'] = 'Vous avez bu',
	['used_tabacsec'] = 'none',

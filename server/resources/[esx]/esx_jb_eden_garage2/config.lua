...
Config.AirplaneBlip	= {sprite= 524, color = 187}
Config.MecanoBlip	= {sprite= 357, color = 26}
Config.Price		= 15000 -- pound price to get vehicle back
Config.SwitchGaragePrice		= 1500 -- price to pay to switch vehicles in garage
...
Config.Garages = {
	...
	Garage_Groove = {
		Pos = {x = -905.235,y = -2433.3,z = 13.831 },
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour ouvrir le garage",
		SpawnPoint = {
			Pos = {x =-911.384,y = -2440.329,z = 13.833 },
			Heading = 225.887,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour sortir votre véhicule"
		},
		DeletePoint = {
			Pos = {x = -918.011,y = -2436.659,z = 13.845 },
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour rentrer votre véhicule"
		}, 	
	},
	...
	Garage_Maison1 = {
		Pos = {x = -1239.675,y = 488.871,z = 93.42 },
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour ouvrir le garage",
		Functionmenu = OpenMenuGarage,
		SpawnPoint = {
			Pos = {x = -1241.338,y = 484.865,z = 93.103 },
			Heading = 264.63,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour sortir votre véhicule",
		...
		DeletePoint = {
		    Pos = {x = -1237.707,y = 477.676,z = 92.736 },
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour rentrer votre véhicule",
	...
	Garage_Maison2 = {
		Pos = {x = -711.31,y = 661.109,z = 155.178 },
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour ouvrir le garage",
		Functionmenu = OpenMenuGarage,
		SpawnPoint = {
			Pos = {x = -698.841,y = 663.523,z = 154.341 },
			Heading = 239.90,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour sortir votre véhicule",
			Functionmenu = ListVehiclesMenu,
		...
		DeletePoint = {
			Pos = {x = -710.299,y = 653.252,z = 155.176 },
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour rentrer votre véhicule",
			Functionmenu = StockVehicleMenu,
		}, 	
	...
	Garage_Maison3 = {
		Pos = {x = -207.395,y = -1541.413,z = 33.850 },
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour ouvrir le garage",
		Functionmenu = OpenMenuGarage,
		SpawnPoint = {
			Pos = {x = -203.951,y = -1536.995,z = 33.850 },
			Heading = 239.90,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour sortir votre véhicule",
			Functionmenu = ListVehiclesMenu,
		...
		DeletePoint = {
			Pos = {x = -199.868,y = -1532.057,z = 33.850 },
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour rentrer votre véhicule",
			Functionmenu = StockVehicleMenu,
		}, 	

...
Config.Zones = {
--ok	CokeField =			{x = 2448.92,	y = -1836.80,	z = 51.95,	name = _U('coke_field'),		sprite = 501,	color = 40},
...
--ok	WeedField =			{x = 1057.6160888672,	y = -3196.8276367188,	z = -40.26130065918,	name = _U('weed_field'),		sprite = 496,	color = 52},

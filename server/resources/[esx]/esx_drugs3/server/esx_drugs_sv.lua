...
RegisterServerEvent('esx_drugs3:startHarvestCoke')
AddEventHandler('esx_drugs3:startHarvestCoke', function()
...
RegisterServerEvent('esx_drugs3:stopHarvestCoke')
AddEventHandler('esx_drugs3:stopHarvestCoke', function()
...
RegisterServerEvent('esx_drugs3:startTransformCoke')
AddEventHandler('esx_drugs3:startTransformCoke', function()
...
RegisterServerEvent('esx_drugs3:stopTransformCoke')
AddEventHandler('esx_drugs3:stopTransformCoke', function()
...
RegisterServerEvent('esx_drugs3:startSellCoke')
AddEventHandler('esx_drugs3:startSellCoke', function()
...
RegisterServerEvent('esx_drugs3:stopSellCoke')
AddEventHandler('esx_drugs3:stopSellCoke', function()
...
RegisterServerEvent('esx_drugs3:startHarvestMeth')
AddEventHandler('esx_drugs3:startHarvestMeth', function()
...
RegisterServerEvent('esx_drugs3:stopHarvestMeth')
AddEventHandler('esx_drugs3:stopHarvestMeth', function()
...
RegisterServerEvent('esx_drugs3:startTransformMeth')
AddEventHandler('esx_drugs3:startTransformMeth', function()
...
RegisterServerEvent('esx_drugs3:stopTransformMeth')
AddEventHandler('esx_drugs3:stopTransformMeth', function()
...
RegisterServerEvent('esx_drugs3:startSellMeth')
AddEventHandler('esx_drugs3:startSellMeth', function()
...
RegisterServerEvent('esx_drugs3:stopSellMeth')
AddEventHandler('esx_drugs3:stopSellMeth', function()
...
RegisterServerEvent('esx_drugs3:startHarvestWeed')
AddEventHandler('esx_drugs3:startHarvestWeed', function()
...
RegisterServerEvent('esx_drugs3:stopHarvestWeed')
AddEventHandler('esx_drugs3:stopHarvestWeed', function()
...
RegisterServerEvent('esx_drugs3:startTransformWeed')
AddEventHandler('esx_drugs3:startTransformWeed', function()
...
RegisterServerEvent('esx_drugs3:stopTransformWeed')
AddEventHandler('esx_drugs3:stopTransformWeed', function()
...
RegisterServerEvent('esx_drugs3:startSellWeed')
AddEventHandler('esx_drugs3:startSellWeed', function()
...
RegisterServerEvent('esx_drugs3:stopSellWeed')
AddEventHandler('esx_drugs3:stopSellWeed', function()
...
RegisterServerEvent('esx_drugs3:startHarvestOpium')
AddEventHandler('esx_drugs3:startHarvestOpium', function()
...
RegisterServerEvent('esx_drugs3:stopHarvestOpium')
AddEventHandler('esx_drugs3:stopHarvestOpium', function()
...
RegisterServerEvent('esx_drugs3:startTransformOpium')
AddEventHandler('esx_drugs3:startTransformOpium', function()
...
RegisterServerEvent('esx_drugs3:stopTransformOpium')
AddEventHandler('esx_drugs3:stopTransformOpium', function()
...
RegisterServerEvent('esx_drugs3:startSellOpium')
AddEventHandler('esx_drugs3:startSellOpium', function()
...
RegisterServerEvent('esx_drugs3:stopSellOpium')
AddEventHandler('esx_drugs3:stopSellOpium', function()
...
RegisterServerEvent('esx_drugs3:GetUserInventory')
AddEventHandler('esx_drugs3:GetUserInventory', function(currentZone)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	TriggerClientEvent('esx_drugs3:ReturnInventory', 
		_source, 
...
ESX.RegisterUsableItem('weed', function(source)
	...
	TriggerClientEvent('esx_drugs3:onPot', _source)
